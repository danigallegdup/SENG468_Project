...
const authenticateToken = require("../middleware/authMiddleware");  // not sure how to update the auth
const authMiddleware = require("../middleware/authMiddleware");
const stockController = require("./controllers/stockController");
const stockManagementController = require("./stockManagementController");
...
/**
 * // backend/matchingEngine/index.js
 * // Routes for matching engine microservice
 * 
 * @route   POST 
 * @route   POST 
 */
